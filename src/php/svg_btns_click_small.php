<svg alt="We have wifi available for your use" version="1.2" baseProfile="tiny" id="wifi_icon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
	 x="0px" y="0px" width="25px" height="25px" viewBox="0 0 25 25" xml:space="preserve" onload="ChangeColor1()">
...
<svg version="1.2" baseProfile="tiny" id="shopping_icon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
	 x="0px" y="0px" width="25px" height="25px" viewBox="0 0 25 25" xml:space="preserve" onload="ChangeColor2()">
...
<svg alt="Telephone available" version="1.2" baseProfile="tiny" id="phone_icon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
	 x="0px" y="0px" width="25px" height="25px" viewBox="0 0 25 25" xml:space="preserve" onload="ChangeColor3()">
...
<svg version="1.1" id="smoking_allowed" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	 width="25px" height="25px" viewBox="0 0 64 64" enable-background="new 0 0 64 64" xml:space="preserve" onload="ChangeColor4()">
	Smoking allowed?
	<script type="text/ecmascript">
 	 <![CDATA[
		var clickedSmoke;
